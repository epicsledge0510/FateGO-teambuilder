...
<div class="navbar-menu" id="navbar-links">
  <a class="navbar-item" href="home.html" id="homeBtn">
    Home
  </a>
  ...
  <a class="navbar-item is-hoverable" href="favorites.html" id="favesBtn">
    Favorites
  </a>

  <a class="navbar-item is-hoverable" href="cloud.html" id="cloudBtn">
    Community
  </a>

  <a class="navbar-item is-hoverable" href="documentation.html" id="docuBtn">
    Documentation
  </a>
</div>
</nav>
...
class NavigationBar extends HTMLElement {
  constructor() {
    ...
    const favesBtn = this.visualizerBtn = this.shadowRoot.querySelector("#favesBtn");
    const docuBtn = this.docuBtn = this.shadowRoot.querySelector("#docuBtn");
    const cloudBtn = this.cloudBtn = this.shadowRoot.querySelector("#cloudBtn");
  ...
  render() {
    ...
    if(page == "home"){
      ...
      favesBtn.style.fontWeight = 400;
      docuBtn.style.fontWeight = 400;
      cloudBtn.style.fontWeight = 400;
    }
    else if(page == "app"){
